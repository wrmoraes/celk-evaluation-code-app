...
public class StateResourceIT {
    ...
    private static final String DEFAULT_INITIALS = "AA";
    private static final String UPDATED_INITIALS = "BB";
    ...
    public void createState() throws Exception {
        ...
        assertThat(testState.getInitials()).isEqualTo(DEFAULT_INITIALS);
    ...
    public void updateState() throws Exception {
        ...
        State testState = stateList.get(stateList.size() - 1);
        assertThat(testState.getInitials()).isEqualTo(UPDATED_INITIALS);
